...
export default function EditAccountRevenue({
  ...
  useEffect(() => {
    ...
    setFormData({
      day: RevenuesSelector.data
        ? RevenuesSelector.data[
            RevenuesSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.day
        : "",
      note: RevenuesSelector.data
        ? RevenuesSelector.data[
            RevenuesSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.Note
        : "",
      payment_amount: RevenuesSelector.data
        ? RevenuesSelector.data[
            RevenuesSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.Payment_amount
        : "",
