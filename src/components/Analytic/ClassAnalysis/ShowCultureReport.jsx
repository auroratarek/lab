...
function ShowCultureReport({
  ...
  const AddToTable = () => {
    ...
    if (!Data.text) {
      document.getElementById("ShowTitle_error").classList.remove("invisible");
    } else {
      document.getElementById("ShowTitle_error").classList.add("invisible");
    }
    if (Data.text) {
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full justify-start space-x-10 col-start-1 col-end-3">
        ...
        <div
          onClick={() => AddToTable()}
          className=" bg-[#0D2135] w-[34%] h-fit  flex items-center justify-center lg:px-10  py-2 rounded-xl cursor-pointer "
        >
