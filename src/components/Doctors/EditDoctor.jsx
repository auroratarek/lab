...
export default function EditDoctor({
  ...
  useEffect(() => {
    {
      console.log(DoctorsSelector.data, "data");
    }
    SetImage(
      DoctorsSelector.data
        ? DoctorsSelector.data[
            DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.gender === "male"
          ? man
          : woman
        : ""
    ...
    setFormData({
      name: DoctorsSelector.data
        ? DoctorsSelector.data[
            DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.name
        : "",
      phone: DoctorsSelector.data
        ? DoctorsSelector.data[
            DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.phone
        : "",
      email: DoctorsSelector.data
        ? DoctorsSelector.data[
            DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.email
        : "",
      // password: DoctorsSelector.data
      //   ? DoctorsSelector.data[
      //       DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
      //     ]?.password
      //   : "",
      ratio: DoctorsSelector.data
        ? DoctorsSelector.data[
            DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.ratio
        : "",
      gender: DoctorsSelector.data
        ? DoctorsSelector.data[
            DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.gender
        : "",
      address: DoctorsSelector.data
        ? DoctorsSelector.data[
            DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.address
        : "",
      src: DoctorsSelector.data
        ? DoctorsSelector.data[
            DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
          ]?.src
        : "",
  ...
  function close() {
    SetImage(
      DoctorsSelector.data
        ? `https://aurora-team.com/labs-obada/${
            DoctorsSelector.data[
              DoctorsSelector.data?.findIndex((unitItem) => unitItem.id === id)
            ]?.src
          }`
    ...
    if (ImageData) {
      ...
      await axios
        ...
        .catch((err) => {
          ...
          if (err.response.data.errors.ratio) {
                ...
                <Dialog.Panel className="relative px-10 pb-8 bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-2 sm:max-w-xl sm:w-full ">
                  <div className="bg-white ">
                    ...
                    <div className="w-full m-auto mt-10">
                      <div
                        className={`
                         w-40 h-40 border-dashed border-2 justify-center
                  ...
                  <div className="bg-white  py-3  flex sm:flex-row-reverse justify-between mt-10">
                    <button
                      ...
                      type="button"
                      disabled={!ready}
                      className={`text-sm font-Poppins-Medium flex flex-grow py-4 ${
