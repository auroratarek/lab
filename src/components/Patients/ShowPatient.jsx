...
export default function ShowPatient({ id, open, setOpen }) {
  ...
  useEffect(() => {
    if (id !== undefined)
      axios
        ...
        .then((res) => {
          console.log(res);
          console.log(res.data.data[0].date_of_visit);
                        ...
                        <div className="w-full m-auto mt-10 ">
                          <div className="w-full  h-full mt-10 grid grid-cols-1 lg:grid-cols-2 gap-5">
                            ...
                            <div className="flex space-y-5 lg:space-y-0 flex-col lg:flex-row w-full">
                              ...
                              >
                                <select
                                  ...
                                  id="DoctorInput"
                                  name="Doctor"
                                  value={allItmes && allItmes.doctor}
                                  className=" w-full   rounded-lg bg-[#F9FAFF]   font-Poppins-Medium  text-[#98A2B3] text-xs  outline-none px-4 py-2 cursor-pointer"
                                >
                                  <option
                                    value=""
                                    ...
                                    className=""
                                  >
                                    {(allItmes && allItmes.doctor) || "Doctor"}
                                  </option>
                                </select>
                                <p
                                  id="Doctor"
                              ...
                              <div className="space-x-1 flex w-full lg:w-[60%]">
                                ...
                                >
                                  <input
                                    ...
                                    id="PriceInput"
                                    name="Price"
                                    value={allItmes && allItmes.price_doctor}
                                    placeholder="Price"
                                    type="text"
                                    className="w-full bg-[#F9FAFF] font-Poppins-Medium text-xs placeholder:text-[#98A2B3] outline-0 ring-0"
                                  />
                                ...
                                >
                                  <input
                                    ...
                                    id="RatioPriceInput"
                                    name="RatioPrice"
                                    value={allItmes && allItmes.ratio_price}
                            ...
                            <div className="flex  w-full">
                              ...
                              >
                                {console.log(allItmes, "hioo")}
                                {console.log(allItmes && allItmes.lab, "hioo")}
                                <select
                                  disabled
                                  name="SentLab"
                                  value={allItmes && allItmes.lab}
                                  id="SentLabInput"
                                  className=" w-full   rounded-lg bg-[#F9FAFF]   font-Poppins-Medium  text-[#98A2B3] text-xs  outline-none px-4 py-2 cursor-pointer"
                                >
                                  <option
                                    ...
                                    className=""
                                  >
                                    {allItmes ? allItmes.lab : "Sent Lab"}
                                  </option>
                                </select>
                                <p
                                  id="SentLab"
                              ...
                              >
                                <input
                                  ...
                                  id="LapIdInput"
                                  name="LapId"
                                  value={allItmes && allItmes.price_lab}
                                  placeholder="0 ID"
                                  type="text"
                                  className="w-full bg-[#F9FAFF] font-Poppins-Medium text-xs placeholder:text-[#98A2B3] outline-0 ring-0"
                                />
                            ...
                            <div className="flex  w-full">
                              ...
                              >
                                <input
                                  ...
                                  id="CompanyIDInput"
                                  name="ID_Company"
                                  value={allItmes && allItmes.price_company}
                                  placeholder="0 ID"
                                  type="text"
                                  className="w-full bg-[#F9FAFF] font-Poppins-Medium text-xs placeholder:text-[#98A2B3] outline-0 ring-0"
                                />
                            ...
                            <div className="w-full">
                              ...
                              >
                                {allItmes
                                  ? allItmes.send_method || "Send method"
                                  : "Send method"}
                                <svg
                                  class="ml-2 w-4 h-4"
                                  aria-hidden="true"
                              ...
                              >
                                ...
                                >
                                  {console.log(allItmes)
                                    ...
                                    : console.log("first")}
                                  {allItmes
                                    ? allItmes.section_name ||
                                      allItmes.section_test_print_name ||
                                      "Analysis type"
                                    : "Analysis type"}
                                </p>
                                {CheckMulit.map((item) => (
                            ...
                            <div className="w-full lg:col-start-1 lg:col-end-3">
                              ...
                              >
                                <p
                                  className={`${
                                    CheckMulitChild.length > 0
                                      ? "hidden"
                                      : "block"
                                  }`}
                                >
                                  {allItmes
                                    ? allItmes.analys_name ||
                                      "Analysis type Child"
                                    : "Analysis type Child"}
                                </p>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 lg:col-start-1 lg:col-end-3 gap-5 ">
                              ...
                              >
                                <input
                                  ...
                                  value={allItmes && allItmes.price_analysis}
                                  name="AnalysisPrice"
                              ...
                              >
                                <input
                                  disabled
                                  value={allItmes && allItmes.paid_up}
                                  id="PaidUpInput"
                                  name="PaidUp"
                            ...
                            >
                              <input
                                disabled
                                value={allItmes && allItmes.discount}
                                id="DiscountInput"
                                name="Discount"
